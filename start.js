        ...
        if (game.active) {
            // if(game.players.length>=3){
                if (msg.author.id == game.creator) {
                    ...
                    // declaration.message(msg,bot)
                }
                else {
                    var embed = utils.embed({
                        msg, title: `Epa!`, thumb: 'https://images.emojiterra.com/twitter/v12/512px/2753.png'
                    }, bot)
            ...
            // else {
            //     var embed = utils.embed({
            //         msg, title: `Para o início do jogo é necessário a presença de 3+ players`, thumb: 'https://images.emojiterra.com/twitter/v12/512px/2753.png'
            //     }, bot)
